  ...
  return `
    <header class="mobile-header" role="banner">
      <div class="mobile-header-brand">
        <button class="mobile-menu-btn ghost-btn" id="mobile-menu-btn" aria-label="Open menu" aria-expanded="false">
...
export function createBottomNav(currentRoute = '#dashboard') {
  const navItems = [
    ...
    { hash: '#more', label: 'Menu', icon: `<circle cx="12" cy="12" r="1"/><circle cx="19" cy="12" r="1"/><circle cx="5" cy="12" r="1"/>`, isMenu: true }
  ];
